@echo off
REM ============================================
REM INSTALADOR E INICIALIZADOR COMPLETO
REM FBA AUTOMATION - WINDOWS
REM Execute como Administrador - Instala TUDO!
REM ============================================
...
echo   [5] Git (controle de versao)
echo   [6] Visual C++ Build Tools (para compilar pacotes)
echo   [7] Todas as dependencias Python (FastAPI, Playwright, etc)
echo   [8] Todas as dependencias Node.js (React, Vite, etc)
echo   [9] Navegadores Playwright (Chromium)
echo   [10] Configurar ambiente virtual Python
echo.
echo ============================================================
...
echo.
echo ============================================================
echo    [1/10] VERIFICANDO/INSTALANDO CHOCOLATEY
echo ============================================================
echo.
...
echo.
echo ============================================================
echo    [2/10] VERIFICANDO/INSTALANDO PYTHON 3.11
echo ============================================================
echo.
...
echo.
echo ============================================================
echo    [3/10] VERIFICANDO/INSTALANDO NODE.JS 20 LTS
echo ============================================================
echo.
...
echo.
echo ============================================================
echo    [4/10] VERIFICANDO/INSTALANDO GOOGLE CHROME
echo ============================================================
echo.
...
REM ============================================
REM PASSO 5: INSTALAR GIT
REM ============================================
echo.
echo ============================================================
echo    [5/10] VERIFICANDO/INSTALANDO GIT
echo ============================================================
echo.
...
REM ============================================
REM PASSO 6: INSTALAR VISUAL C++ BUILD TOOLS
REM ============================================
echo.
echo ============================================================
echo    [6/10] VERIFICANDO/INSTALANDO BUILD TOOLS
echo ============================================================
echo.
...
REM ============================================
REM PASSO 7: CRIAR VIRTUAL ENVIRONMENT PYTHON
REM ============================================
echo.
echo ============================================================
echo    [7/10] CRIANDO VIRTUAL ENVIRONMENT PYTHON
echo ============================================================
echo.
...
REM ============================================
REM PASSO 8: INSTALAR DEPENDENCIAS PYTHON
REM ============================================
echo.
echo ============================================================
...
REM ============================================
REM PASSO 9: INSTALAR DEPENDENCIAS NODE.JS
REM ============================================
echo.
echo ============================================================
echo    [9/10] INSTALANDO DEPENDENCIAS NODE.JS (FRONTEND)
echo ============================================================
echo.
...
REM ============================================
REM PASSO 10: CRIAR PASTAS NECESSARIAS
REM ============================================
echo.
echo ============================================================
echo    [10/10] CONFIGURANDO ESTRUTURA DO PROJETO
echo ============================================================
echo.
